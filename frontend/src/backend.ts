...
export class Backend implements backendInterface {
    ...
    async addAd(arg0: string, arg1: string, arg2: string, arg3: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addAd(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addExam(arg0: string, arg1: string, arg2: string, arg3: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addExam(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addStudent(arg0: string, arg1: bigint, arg2: string, arg3: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async toggleAdActive(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.toggleAdActive(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
